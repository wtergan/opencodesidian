...
2. Search the vault for relevant existing notes in:
   - `03_Resources/` for reference materials
   - `01_Projects/` for active work
   - `02_Areas/` for ongoing responsibilities
   - `07_OLD_VAULT/memories/` for past context (if migrated)
